...
export interface Mutation {
  ...
  EmailSingIn: EmailSingInResponse;
...
export interface EmailSingInResponse {
  ok: boolean;
  error: string | null;
  token: string | null;
}
